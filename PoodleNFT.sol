...
contract PoodleNFT is Context, IERC20, Ownable {
    ...
    string private _name = "PoodleNFT";
	...
	function excludeForDxSale(address account) public onlyOwner {
        _isExcludedFromMaxTX[account] = true;
		_isExcludedFromFee[account] = true;
    }
	
    function includeForDxSale(address account) public onlyOwner {
